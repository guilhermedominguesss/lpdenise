...
export default function PortfolioHero() {
  ...
  // We start with light theme as requested "Background off-white"
  useEffect(() => {
  ...
  const brandColor = "#AF8883"; // Rose Burnt

  return (
    <div 
      className="min-h-screen text-foreground transition-colors"
      style={{
        backgroundColor: isDark ? "hsl(0 0% 5%)" : "#FDFBF9",
    ...
    >
      ...
      <header className="fixed top-0 left-0 right-0 z-50 px-6 py-6">
        <nav className="flex items-center justify-between max-w-screen-2xl mx-auto">
              ...
              >
                {menuItems.map((item) => (
                  <a
                    ...
                    style={{
                      color: item.highlight ? brandColor : isDark ? "hsl(0 0% 100%)" : "hsl(0 0% 10%)",
                    }}
                    onMouseEnter={(e) => {
                      e.currentTarget.style.color = brandColor;
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.color = item.highlight ? brandColor : (isDark ? "hsl(0 0% 100%)" : "hsl(0 0% 10%)");
                    }}
          ...
          {/* Signature */}
          <div className="text-4xl" style={{ color: isDark ? "hsl(0 0% 100%)" : brandColor, fontFamily: "'Brush Script MT', 'Lucida Handwriting', cursive" }}>
            D
          </div>
          ...
          >
            <div
              ...
              style={{
                backgroundColor: isDark ? "hsl(0 0% 100%)" : brandColor,
      ...
      <main className="relative min-h-screen flex flex-col">
          ...
          <div className="relative text-center">
            <div>
              <BlurText
                ...
                style={{ color: brandColor, fontFamily: "'Fira Code', monospace" }}
              />
            </div>
            <div>
              <BlurText
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
                <div className="w-[65px] h-[110px] sm:w-[90px] sm:h-[152px] md:w-[110px] md:h-[185px] lg:w-[129px] lg:h-[218px] rounded-full overflow-hidden shadow-2xl transition-transform duration-300 hover:scale-110 cursor-pointer border-4 border-white/50">
                  <img
                    src="/images/dra-denise-2.jpeg"
                    alt="Dra. Denise"
        ...
        <div className="absolute bottom-16 sm:bottom-20 md:bottom-24 lg:bottom-32 xl:bottom-36 left-1/2 -translate-x-1/2 w-full px-6">
          <div className="flex justify-center">
            <BlurText
              text="Beleza real, resultados naturais e identidade."
              delay={150}
              animateBy="words"
              direction="top"
